...
object EnglishRiddles {
    ...
    private val easyRiddles = listOf(
        RiddleResponseRemote(
            question = "What can I see with my eyes closed?",
            answer = "Dreams"
        ),
        RiddleResponseRemote(
            question = "What is always there but never gets saturated?",
            answer = "Hunger"
        ),
        RiddleResponseRemote(
            question = "Who always goes but never comes?",
            answer = "Sun"
        ),
        RiddleResponseRemote(
            question = "What grows when you feed, but dies if you drink?",
            answer = "Plant or flower"
        ),
        RiddleResponseRemote(
            question = "What can be broken without even touching?",
            answer = "Silence"
        ),
        RiddleResponseRemote(
            question = "Which room never has furniture?",
            answer = "Mushroom house (mushroom growing room)"
        ),
        RiddleResponseRemote(
            question = "What always goes, but never runs, and always runs, but never goes?",
            answer = "Clock"
        ),
        RiddleResponseRemote(
            question = "Which word becomes shorter if you add a letter to it?",
            answer = "The word 'short'"
        ),
        RiddleResponseRemote(
            question = "What becomes more and more when you add more and more?",
            answer = "Pit or pit."
        ),
        RiddleResponseRemote(
        ...
        RiddleResponseRemote(
            question = "It goes up, but it never goes down. What is it?",
            answer = "Age"
        ),
        RiddleResponseRemote(
            question = "What can be taken in the left hand, but cannot be taken in the right?",
            answer = "Right hand"
        ),
        RiddleResponseRemote(
            question = "What word can be written with one letter?",
            answer = "Word'o'"
        ),
        RiddleResponseRemote(
        ...
        RiddleResponseRemote(
            question = "What can be broken if dropped, but cannot be repaired?",
            answer = "Egg"
        ),
        RiddleResponseRemote(
            question = "What can be shared, but not eaten?",
            answer = "Secret"
        ),
        RiddleResponseRemote(
            question = "What does every person have, and it always ends with the number 5?",
            answer = "His age"
        ),
        RiddleResponseRemote(
            question = "A pear is hanging, you can't eat. What is it?",
            answer = "Light bulb"
        ),
        RiddleResponseRemote(
        ...
        RiddleResponseRemote(
            question = "Which one grows up by the roots?",
            answer = "Lotus"
        ),
        RiddleResponseRemote(
            question = "What will hang in the air if it doesn't fall to the ground?",
            answer = "Shadow"
        ),
        RiddleResponseRemote(
        ...
        RiddleResponseRemote(
            question = "What can I buy but not eat?",
            answer = "Dishes"
        ),
        RiddleResponseRemote(
            question = "What can he say but not listen to?",
            answer = "Phone"
        ),
        RiddleResponseRemote(
            question = "How many moons are there in the sky?",
            answer = "One"
        ),
        RiddleResponseRemote(
        ...
        RiddleResponseRemote(
            question = "What can you hear but never see?",
            answer = "Echo"
        ),
        RiddleResponseRemote(
            question = "Which sea has no shores?",
            answer = "Dead Sea"
        ),
        RiddleResponseRemote(
            question = "Who can walk on water without jumping or swimming?",
            answer = "Shadow."
        ),
        RiddleResponseRemote(
            question = "Which key doesn't open any doors?",
            answer = "Fake key"
        ),
        RiddleResponseRemote(
            question = "When does the water boil?",
            answer = "When it reaches its boiling point.(100)"
        ),
        RiddleResponseRemote(
            question = "What does a person have only one, an animal has two, but a bird does not?",
            answer = "Nose"
        ),
        RiddleResponseRemote(
        ...
        RiddleResponseRemote(
            question = "What always goes down but never rises?",
            answer = "Rain"
        ),
        RiddleResponseRemote(
            question = "Which word becomes shorter if you remove the letters from it?",
            answer = "Briefly"
        ),
        RiddleResponseRemote(
            question = "What can be seen in the dark, but not in the light?",
            answer = "Dream"
        ),
        RiddleResponseRemote(
            question = "What goes around the whole world but stays in the corner?",
            answer = "Stamp on a postage stamp"
        ),
        RiddleResponseRemote(
            question = "Which animal can speak all languages?",
            answer = "Parrot"
        ),
        RiddleResponseRemote(
            question = "What smiles but doesn't have a mouth?",
            answer = "Photo"
        ),
        RiddleResponseRemote(
            question = "What can be broken with one touch?",
            answer = "Light"
        ),
        RiddleResponseRemote(
            question = "What grows up by the roots?",
            answer = "Teeth"
        ),
        RiddleResponseRemote(
            question = "What never stands still but never moves?",
            answer = "Conversation"
        ),
        RiddleResponseRemote(
            question = "At what point does everyone become older than their father?",
            answer = "On my birthday"
        ),
        RiddleResponseRemote(
            question = "What can be held in the left hand, but cannot be held in the right?",
            answer = "Right hand"
        ),
        RiddleResponseRemote(
        ...
        RiddleResponseRemote(
            question = "What can be heard but not said?",
            answer = "Silence"
        ),
        RiddleResponseRemote(
            question = "What hangs in the air and does not fall?",
            answer = "Question"
        ),
        RiddleResponseRemote(
            question = "What is always walking next to you, but can never catch up with you?",
            answer = "Shadow"
        ),
        RiddleResponseRemote(
            question = "What begins and ends with the letter 'e' but has only one letter?",
            answer = "Letter 'e'"
        ),
        RiddleResponseRemote(
            question = "Which word can be read back and forth and it will remain the same?"
                    answer = "It"
        ),
        RiddleResponseRemote(
            question = "What can you break if you say his name?",
            answer = "Mirror"
        ),
        RiddleResponseRemote(
            question = "What doesn't have a body, but can hit you?",
            answer = "Word"
        ),
        RiddleResponseRemote(
            question = "Which key can't be turned in the lock?",
            answer = "Treble clef"
        ),
        RiddleResponseRemote(
            question = "What makes steps backward when they go forward?",
            answer = "Escalator"
        ),
        RiddleResponseRemote(
            question = "What falls but never crashes?",
            answer = "Snow"
        ),
        RiddleResponseRemote(
            question = "What does everyone have, but everyone gives it to others?",
            answer = "Word"
        ),
        RiddleResponseRemote(
            question = "What can be done only once in a lifetime?",
            answer = "To be born"
        ),
        RiddleResponseRemote(
            question = "What does everyone have, and it always ends with the number 5?",
            answer = "Age"
        ),
        RiddleResponseRemote(
            question = "What can I take off but not put on?",
            answer = "Consequences"
        ),
        RiddleResponseRemote(
            question = "What flies without wings and falls without a parachute?",
            answer = "Snowflake"
        ),
        RiddleResponseRemote(
            question = "What goes up and never goes down?",
            answer = "Age"
        ),
        RiddleResponseRemote(
            question = "What grows when it is fed, but dies when it is watered?",
            answer = "Candle"
        ),
        RiddleResponseRemote(
            question = "What can be done on the table, but can't be eaten?",
            answer = "Deck of cards"
        ),
        RiddleResponseRemote(
            question = "What increases when you take from it?",
            answer = "Seam"
        ),
        RiddleResponseRemote(
            question = "What always goes forward, but never comes to light?",
            answer = "Past"
        ),
        RiddleResponseRemote(
            question = "What has eyes but doesn't see?",
            answer = "Needle"
        ),
        RiddleResponseRemote(
            question = "What can you wear on your head but never see?",
            answer = "Header"
        ),
        RiddleResponseRemote(
            question = "What can only be divided in half?",
            answer = "Cookie"
        ),
        RiddleResponseRemote(
            question = "What starts with the head and ends with the tail?",
            answer = "Boa constrictor"
        ),
        RiddleResponseRemote(
            question = "That he always lies, but never tells a lie?",
            answer = "Counter"
        ),
        RiddleResponseRemote(
        ...
        RiddleResponseRemote(
            question = "What gets smaller when you take more?",
            answer = "Step"
        ),
        RiddleResponseRemote(
            question = "What does everyone have, and every day is getting smaller and smaller?",
            answer = "Time"
        ),
        RiddleResponseRemote(
            question = "What can't be seen, but you can hear, and if you drop it, it will break?",
            answer = "Echo"
        ),
        RiddleResponseRemote(
        ...
        RiddleResponseRemote(
            question = "What is born in the moment, but lives for years?",
            answer = "Moment"
        ),
        RiddleResponseRemote(
            question = "What always comes but never comes home?",
            answer = "Tomorrow"
        ),
        RiddleResponseRemote(
            question = "What gets wet when you wipe it?",
            answer = "Towel"
        ),
        RiddleResponseRemote(
            question = "What can be taken but not given away?",
            answer = "Memory"
        ),
        RiddleResponseRemote(
            question = "What can't be seen until it disappears?",
            answer = "Shadow"
        ),
        RiddleResponseRemote(
            question = "What always flies without wings and dies without a sound?",
            answer = "Conscience"
        ),
        RiddleResponseRemote(
            question = "Call her by her name and she will disappear",
            answer = "Silence"
        ),
        RiddleResponseRemote(
            question = "What lifts you up and lowers you down, but is itself in place?",
            answer = "Escalator"
        ),
        RiddleResponseRemote(
            question = "What will be better if it is trampled?",
            answer = "Path"
        ),
        RiddleResponseRemote(
            question = "What doesn't chew, but devours everything?",
            answer = "Fire"
        ),
        RiddleResponseRemote(
            question = "Where I go, she goes",
            answer = "Shadow"
        ),
        RiddleResponseRemote(
            question = "Inanimate, but walking, motionless, but leading",
            answer = "Road"
        ),
        RiddleResponseRemote(
        ...
        RiddleResponseRemote(
            question = "What is it: have four colors, change them every three months?",
            answer = "Seasons"
        ),
        RiddleResponseRemote(
        ...
        RiddleResponseRemote(
            question = "Who was born in the sky and buried in the earth?",
            answer = "Rain, hail"
        ),
        RiddleResponseRemote(
        ...
        RiddleResponseRemote(
            question = "Which word always sounds wrong?",
            answer = "Incorrect"
        ),
        RiddleResponseRemote(
        ...
        RiddleResponseRemote(
            ...
            answer = "Not at all, peas don't go"
        ),
        RiddleResponseRemote(
            question = "What is thrown when it is needed, and picked up when it is not needed?",
            answer = "Sea anchor"
        ),
        RiddleResponseRemote(
            question = "What kind of dishes can't you eat anything from?",
            answer = "From empty"
        ),
        RiddleResponseRemote(
            question = "What can I share only once?",
            answer = "Secret"
        ),
        RiddleResponseRemote(
            question = "What will become bigger if you turn it upside down?",
            answer = "Number 9"
        ),
        RiddleResponseRemote(
            question = "How many years in a year?",
            answer = "One summer"
        ),
        RiddleResponseRemote(
            question = "Which teeth are the last to appear in a person?",
            answer = "Artificial"
        ),
        RiddleResponseRemote(
            question = "What happens if the drum is divided into drums",
            answer = "Drum roll"
        ),
        RiddleResponseRemote(
        ...
        RiddleResponseRemote(
            question = "Who do Australians call a sea wasp?",
            answer = "Jellyfish"
        ),
        RiddleResponseRemote(
        ...
        RiddleResponseRemote(
            question = "Moscow used to be called white stone. And which city was called black?",
            answer = "Chernihiv"
        ),
        RiddleResponseRemote(
        ...
        RiddleResponseRemote(
            question = "When is the best time for a black cat to get into the house?",
        ...
        RiddleResponseRemote(
            question = "Small, gray looks like an elephant. Who is this?",
            answer = "Baby Elephant"
        ),
        RiddleResponseRemote(
            question = "Which hand is better to stir the tea with?",
            answer = "The one with the spoon in it"
        ),
        RiddleResponseRemote(
        ...
        RiddleResponseRemote(
            question = "Which question can't be answered “yes”?",
            answer = "Are you asleep?"
        ),
        RiddleResponseRemote(
            question = "Which question can't be answered “no”?",
            answer = "Are you alive?"
        ),
        RiddleResponseRemote(
            question = "How do day and night end?",
            answer = "Soft sign"
        ),
        RiddleResponseRemote(
        ...
        RiddleResponseRemote(
            question = "What should I do to keep five guys in one boot?",
            answer = "Take off a boot for each of them"
        ),
        RiddleResponseRemote(
            question = "How much will it be 2+2*2 ?",
            answer = "Six"
        ),
        RiddleResponseRemote(
        ...
        RiddleResponseRemote(
            question = "How to find last year's snow?",
            answer = "Go outside right after the start of the new year"
        ),
        RiddleResponseRemote(
            question = "A man has one, a cow has two, a hawk has none. What is it?",
            answer = "Letter ‑O-"
        ),
        RiddleResponseRemote(
        ...
        RiddleResponseRemote(
            question = "What stones are not in the sea?",
            answer = "Dry"
        ),
        RiddleResponseRemote(
        ...
        RiddleResponseRemote(
            question = "Can a rooster call himself a bird?",
            answer = "No, because he can't speak"
        ),
        RiddleResponseRemote(
            question = "What disease on earth has no one been sick with?",
            answer = "Marine"
        ),
        RiddleResponseRemote(
            question = "Is it possible to predict the score of any match before it starts?",
            answer = "Yes, 0 – 0"
        ),
        RiddleResponseRemote(
            question = "Which figure will decrease by a third if you flip it over?",
            answer = "Digit 9"
        ),
        RiddleResponseRemote(
        ...
        RiddleResponseRemote(
            question = "Which knot can't be untied?",
            answer = "Railway"
        ),
        RiddleResponseRemote(
            question = "What's in front of the cow and behind the bull?",
            answer = "Letter ‑K-"
        ),
        RiddleResponseRemote(
            question = "Which river is the scariest?",
            answer = "Tiger"
        ),
        RiddleResponseRemote(
            question = "What has no length, depth, width, height, but can be measured?",
            answer = "Temperature, time"
        ),
        RiddleResponseRemote(
            question = "What are all the people on earth doing at the same time?",
        ...
        RiddleResponseRemote(
            question = "Where is the edge of the world?",
        ...
        RiddleResponseRemote(
            question = "What can you easily lift from the ground, but not throw far?",
            answer = "Poplar fluff"
        ),
        RiddleResponseRemote(
            question = "Which comb won't you comb your head with?",
            answer = "Cockerel"
        ),
        RiddleResponseRemote(
        ...
        RiddleResponseRemote(
            question = "What notes can measure the distance?",
            answer = "Mi-La-Mi"
        ),
        RiddleResponseRemote(
            question = "What won't go into the biggest pot?",
            answer = "Her cover"
        ),
        RiddleResponseRemote(
        ...
        RiddleResponseRemote(
            question = "Which animals always sleep with their eyes open?",
            answer = "Fish"
        ),
        RiddleResponseRemote(
            question = "What insects are domesticated by man?",
            answer = "Bees"
        ),
        RiddleResponseRemote(
            question = "Why can't a porcupine drown?",
            answer = "His needles are hollow"
        ),
        RiddleResponseRemote(
            question = "Name the plant that has the largest fruits?",
            answer = "Pumpkin"
        ),
        RiddleResponseRemote(
        ...
        RiddleResponseRemote(
            question = "A person has twelve pairs of ribs. And who has about three hundred ribs?",
            answer = "The snake"
        ),
        RiddleResponseRemote(
        ...
        RiddleResponseRemote(
            question = "The loaf was cut into three parts. How many incisions were made?",
            answer = "Two cuts"
        ),
        RiddleResponseRemote(
            question = "Which is lighter than 1 kg of cotton wool or 1 kg of iron?",
            answer = "The same"
        ),
        RiddleResponseRemote(
        ...
        RiddleResponseRemote(
            question = "Born twice, dies once. Who is this?",
            answer = "Chicken"
        ),
        RiddleResponseRemote(
            question = "What can't you lift off the floor by the tail?",
            answer = "Tangle"
        ),
        RiddleResponseRemote(
            question = "Why are riddles dangerous to the head?",
            answer = "Because people are puzzling over it"
        ),
        RiddleResponseRemote(
            question = "What can snow and lilac bushes have in common?",
            answer = "Color. Lilac flowers are also white"
        ),
        RiddleResponseRemote(
        ...
        RiddleResponseRemote(
            question = "Which side of the world has one hundred and one letters in its name?",
            answer = "East"
        ),
        RiddleResponseRemote(
            question = "They go with a load, they stop without a load",
            answer = "Clock with weights"
        ),
        RiddleResponseRemote(
            question = "Who has a mustache longer than legs?",
            answer = "Cancer, cockroach"
        ),
        RiddleResponseRemote(
            question = "What was 'tomorrow' and will be 'yesterday'",
            answer = "Today"
        ),
        RiddleResponseRemote(
            question = "Six legs, two heads, and one tail. What is it?",
            answer = "Rider on a horse"
        ),
        RiddleResponseRemote(
            question = "Which clock shows the correct time only twice a day?",
            answer = "Who stopped"
        ),
        RiddleResponseRemote(
        ...
        RiddleResponseRemote(
            question = "How can I put two liters of milk in a liter jar?",
            answer = "Cook condensed milk from it"
        ),
        RiddleResponseRemote(
        ...
        RiddleResponseRemote(
            question = "8 + 7 = 13 or 7 + 8 = 13?",
            answer = "8 + 7 = 15, not 13"
        ),
        RiddleResponseRemote(
        ...
        RiddleResponseRemote(
            question = "From which fabric can't you sew a shirt?",
            answer = "From railway fabric."
        ),
        RiddleResponseRemote(
            question = "He is my father's son, but not my brother. Who is he?",
            answer = "He is me."
        ),
        RiddleResponseRemote(
            question = "How to spell 'mouse trap' in five letters?",
            answer = "Cat."
        ),
        RiddleResponseRemote(
            question = "Who do people take their hats off to?",
            answer = "To the hairdresser."
        ),
        RiddleResponseRemote(
            question = "When can a person move at the speed of a racing car?",
            answer = "When they are inside it."
        ),
        RiddleResponseRemote(
            question = "Which baby is born with a mustache?",
            answer = "For example, a kitten."
        ),
        RiddleResponseRemote(
        ...
        RiddleResponseRemote(
            question = "It is born twice and dies once.",
            answer = "A chicken."
        ),
        RiddleResponseRemote(
        ...
        RiddleResponseRemote(
            question = "Which city contains a man's name and a cardinal direction?",
            answer = "Vladivostok."
        ),
        RiddleResponseRemote(
        ...
        RiddleResponseRemote(
            question = "What should you put on a pie before eating it?",
            answer = "Teeth."
        ),
        RiddleResponseRemote(
        ...
        RiddleResponseRemote(
            question = "What do milk and hedgehogs have in common?",
            answer = "The ability to curdle."
        ),
        RiddleResponseRemote(
            question = "What goes frequently but travels rarely?",
            answer = "A staircase."
        ),
        RiddleResponseRemote(
        ...
        RiddleResponseRemote(
            question = "What kind of plug can't be used to seal a bottle?",
            answer = "A traffic jam."
        ),
        RiddleResponseRemote(
            question = "They can be metallic or liquid. What are we talking about?",
            answer = "Nails."
        ),
        RiddleResponseRemote(
            question = "Who has a heel in front of their nose?",
            answer = "Shoes."
        ),
        RiddleResponseRemote(
        ...
        RiddleResponseRemote(
            question = "What can't you eat for breakfast?",
            answer = "Lunch and dinner."
        ),
        RiddleResponseRemote(
            question = "How many letters are in the alphabet?",
            answer = "Seven, if you count A-L-P-H-A-B-E-T."
        ),
        RiddleResponseRemote(
        ...
        RiddleResponseRemote(
            question = "What consists of one word but has thousands of letters?",
            answer = "Mail."
        ),
        RiddleResponseRemote(
        ...
        RiddleResponseRemote(
            question = "Who has a heel in front and a heel in back?",
            answer = "The letter 'C'."
        ),
        RiddleResponseRemote(
            question = "Two bellies - four ears.",
            answer = "A pillow."
        )
                RiddleResponseRemote(
                question = "Which faucet can't you wash your hands with?",
        answer = "A tower faucet."
    ),
    RiddleResponseRemote(
    question = "Can it rain for two consecutive days?",
    answer = "No, there is a night between them."
    ),
    RiddleResponseRemote(
    question = "What does half an orange resemble the most?",
    answer = "The other half of the orange."
    ),
    RiddleResponseRemote(
    ...
    RiddleResponseRemote(
    question = "How many sheep does Abdul have left?",
    answer = "14."
    ),
    RiddleResponseRemote(
    ...
    RiddleResponseRemote(
    question = "Where does Tuesday come before Monday?",
    ...
    RiddleResponseRemote(
    question = "What can be found in December but not in any other month?",
    answer = "The letter 'D'."
    ),
    RiddleResponseRemote(
    question = "What invention allows you to see through walls?",
    answer = "A door."
    ),
    RiddleResponseRemote(
    question = "More than an hour, less than a minute.",
    answer = "A second, the hand of some clock models."
    ),
    RiddleResponseRemote(
    ...
    RiddleResponseRemote(
    question = "What table doesn't have legs?",
    answer = "A diet table."
    ),
    RiddleResponseRemote(
    question = "How can a person stay awake for 8 days?",
    answer = "By sleeping at night."
    ),
    RiddleResponseRemote(
    question = "Which animal do people walk on and cars drive on?",
    answer = "A zebra crossing."
    ),
    RiddleResponseRemote(
    question = "In which word is 'no' used 100 times?",
    answer = "Groans."
    ),
    RiddleResponseRemote(
    question = "What path has never been walked or driven on by anyone?",
    answer = "The Milky Way."
    ),
    RiddleResponseRemote(
    question = "Which drink and natural phenomenon are hidden in one word?",
    answer = "Grapes (grape + rain)."
    ),
    RiddleResponseRemote(
    question = "There are seven brothers for one sister. How many sisters are there in total?",
    answer = "One."
    ),
    RiddleResponseRemote(
    ...
    RiddleResponseRemote(
    question = "Small and distant, resembling an onion. Bitter and burns too.",
    answer = "Garlic."
    ),
    RiddleResponseRemote(
    question = "Anna closed her eyes. What can Anna see without opening them?",
    answer = "Dreams."
    ),
    RiddleResponseRemote(
    ...
    RiddleResponseRemote(
    question = "Who doesn't have enough money to even shave their beard?",
    answer = "A goat."
    ),
    RiddleResponseRemote(
    ...
    RiddleResponseRemote(
    question = "A horse is running and running, but what can't it run away from?",
    answer = "Its own tail."
    ),
    RiddleResponseRemote(
    question = "Which animal wears a stone shirt?",
    answer = "A turtle."
    ),
    RiddleResponseRemote(
    ...
    RiddleResponseRemote(
    question = "A person has ten fingers on their hands. How many fingers are on ten hands?",
    answer = "50."
    ),
    RiddleResponseRemote(
    ...
    RiddleResponseRemote(
    question = "The more of them you have, the less they weigh. What are they?",
    answer = "Holes."
    ),
    RiddleResponseRemote(
    question = "What is always spoken about in future tense?",
    answer = "Tomorrow."
    ),
    RiddleResponseRemote(
    ...
    RiddleResponseRemote(
    question = "The grandmother carried a hundred eggs to the bazaar, and the bottom fell, how many eggs were left in the basket.",
    ...
    RiddleResponseRemote(
    question = "Perekrestok, svetofor. KAMAZ, povozka i motRiddleResponseRemote(
    question = "A grandmother was carrying a hundred eggs to the market, but the bottom fell out of the basket. How many eggs are left in the basket?",
    answer = "None, because the bottom fell out"
    ),
    RiddleResponseRemote(
    ...
    private val hardRiddles = listOf(
        ...
        RiddleResponseRemote(
            question = "When does 11 + 3 equal 2?",
            answer = "On a clock."
        ),
        RiddleResponseRemote(
        ...
        RiddleResponseRemote(
            question = "What does one math textbook say to another?",
    ...
    RiddleResponseRemote(
    question = "What is impossible to put in the pot?",
    answer = "The lid from it, it's always a little bigger"
    ),
    RiddleResponseRemote(
    question = "I have eyes, but I can't see anything with them. What am I?",
    answer = "Potato"
    ),
    RiddleResponseRemote(
    question = "She is your uncle's sister, but not your aunt. Who is she to you?",
    answer = "Mom"
    ),
    RiddleResponseRemote(
    question = "I can eat endlessly and will never be full. What am I?",
    answer = "Fire"
    ),
    RiddleResponseRemote(
    question = "I have neither arms nor legs, but I can get into the house in winter.",
    answer = "Cold, frost"
    ),
    RiddleResponseRemote(
    ...
    RiddleResponseRemote(
    question = "We do not know grief and sorrow, but we cry.",
    answer = "Clouds"
    ),
    RiddleResponseRemote(
    ...
    RiddleResponseRemote(
    question = "Today is tomorrow, and tomorrow will be yesterday.",
    answer = "Today"
    ),
    RiddleResponseRemote(
    question = "A beast that walks and rests all summer, and sleeps in winter.",
    answer = "Bear"
    ),
    RiddleResponseRemote(
    question = "The whole forest is on itself.",
    answer = "Hedgehog"
    ),
    RiddleResponseRemote(
    question = "A tree wears on its head.",
    answer = "Deer"
    ),
    RiddleResponseRemote(
    question = "Can go on a trip without leaving his own home.",
    answer = "Snail"
    ),
    RiddleResponseRemote(
    question = "Without axes and saws, is there a house in the forest near a pine tree?",
    answer = "Ants"
    ),
    RiddleResponseRemote(
    question = "Not a hammer, but a tree will step on.",
    answer = "Woodpecker"
    ),
    RiddleResponseRemote(
    question = "If you throw me into the ground alone, you can collect a whole handful later.",
    answer = "Seed"
    ),
    RiddleResponseRemote(
    question = "We are not the sea, but we are worried in the wind.",
    answer = "Ears"
    ),
    RiddleResponseRemote(
    ...
    RiddleResponseRemote(
    question = "We've been walking all our lives, but we can't go anywhere.",
    answer = "Clock hands"
    ),
    RiddleResponseRemote(
    question = "Two twin brothers who can never see each other",
    answer = "Eyes"
    ),
    RiddleResponseRemote(
    question = "It would be impossible to say anything without it.",
    answer = "Language"
    ),
    RiddleResponseRemote(
    question = "It's easy to wear them, even if they are long, but it's impossible to count.",
    answer = "Hair"
    ),
    RiddleResponseRemote(
    question = "They can never overtake each other, they walk side by side all their lives.",
    answer = "Legs"
    ),
    RiddleResponseRemote(
    question = "They always look at each other, but they can't get together.",
    answer = "Floor and ceiling"
    ),
    RiddleResponseRemote(
    question = "He walks and walks, but he never comes into the house.",
    ...
    RiddleResponseRemote(
    question = "There are wings, but not a bird. It flies, but it doesn't flap its wings.",
    answer = "Airplane"
    ),
    RiddleResponseRemote(
    question = "You can't get sick with this disease on earth.",
    answer = "Seasickness"
    ),
    RiddleResponseRemote(
    ...
    RiddleResponseRemote(
    question = "What question will no person ever answer 'Yes' to?",
    answer = "Are you asleep?"
    ),
    RiddleResponseRemote(
    ...
    RiddleResponseRemote(
    question = "What is under our feet when we walk on the road?",
    answer = "Sole"
    ),
    RiddleResponseRemote(
    question = "What does half a pear look like the most?",
    answer = "To your other half"
    ),
    RiddleResponseRemote(
    question = "Shortest month?",
    answer = "May"
    ),
    RiddleResponseRemote(
    ...
    RiddleResponseRemote(
    question = "Standing over the water, shaking his head.",
    answer = "Reed"
    ),
    RiddleResponseRemote(
    question = "No legs, no wings, but you won't catch up.",
    answer = "Fish"
    ),
    RiddleResponseRemote(
    ...
    RiddleResponseRemote(
    question = "It's winding around, but it's impossible to catch.",
    answer = "Wind"
    ),
    RiddleResponseRemote(
    question = "They walk all their lives, but they don't leave.",
    answer = "The hands of the clock"
    ),
    RiddleResponseRemote(
    question = "Always there, but it's impossible to catch up or overtake her.",
    answer = "Shadow"
    ),
    RiddleResponseRemote(
    question = "The edge is visible, but it is impossible to reach it.",
    answer = "Horizon"
    ),
    RiddleResponseRemote(
    ...
    RiddleResponseRemote(
    question = "A hole into which you can lower the fishing rod.",
    answer = "Ice hole"
    ),
    RiddleResponseRemote(
    ...
    RiddleResponseRemote(
    question = "You'll sleep in class — you'll get an answer for it",
    answer = "not five, but two"
    ),
    RiddleResponseRemote(
    ...
    RiddleResponseRemote(
    question = "Sitting in a dungeon, a red maiden, and a scythe on the street.",
    answer = "Carrot"
    ),
    RiddleResponseRemote(
    question = "Who goes cold in winter angry, hungry?",
    answer = "Wolf"
    ),
    RiddleResponseRemote(
    question = "Does not bark, does not bite, and does not let into the house",
    answer = "Lock"
    ),
    RiddleResponseRemote(
    ...
    RiddleResponseRemote(
    question = "White piglets lay down on the bed.",
    answer = "Zucchini"
    ),
    RiddleResponseRemote(
    question = "It shines and glitters, it does not flatter anyone.",
    answer = "Mirror"
    ),
    RiddleResponseRemote(
    question = "The poor thing will hide in the board — his cap is barely visible",
    answer = "Nail"
    ),
    RiddleResponseRemote(
    question = "Winter and summer are the same color.",
    answer = "Christmas tree"
    ),
    RiddleResponseRemote(
    question = "Shine first, crackle after shine!",
    answer = "Thunderstorm"
    ),
    RiddleResponseRemote(
    ...
    RiddleResponseRemote(
    question = "Striped balls came to us from the melon.",
    answer = "Watermelon"
    ),
    RiddleResponseRemote(
    question = "White peas on a green leg.",
    ...
    RiddleResponseRemote(
    question = "A log is floating on the river. Oh, and it's feisty!",
    answer = "Crocodile"
    ),
    RiddleResponseRemote(
    ...
    RiddleResponseRemote(
    question = "I wake everyone up on time, even if I don't start the clock.",
    answer = "Rooster"
    ),
    RiddleResponseRemote(
    ...
    RiddleResponseRemote(
    question = "He is empty, his voice is thick, the drum beats, it helps to walk and sing.",
    answer = "Drum"
    ),
    RiddleResponseRemote(
    question = "If he falls, he jumps, if he hits, he doesn't cry.",
    answer = "Ball"
    ),
    RiddleResponseRemote(
    question = "Oh, don't touch me: I'll burn without fire!",
    answer = "Nettle"
    ),
    RiddleResponseRemote(
    ...
    RiddleResponseRemote(
    question = "He starts digging, replaces a hundred shovels.",
    answer = "Excavator"
    ),
    RiddleResponseRemote(
    ...
    RiddleResponseRemote(
    question = "Steel horse, linen tail",
    answer = "Needle and thread"
    ),
    RiddleResponseRemote(
    question = "Burns without fire, flies without wings, runs without legs.",
    answer = "Sun, clouds, river"
    ),
    RiddleResponseRemote(
    question = "A hut was built without hands, without a hatchet.",
    answer = "Nest"
    ),
    RiddleResponseRemote(
    question = "scarlet, sugar, green caftan, velvet.",
    answer = "Watermelon"
    ),
    RiddleResponseRemote(
    question = "In haymaking — bitter, and in frost — sweet. What kind of berry?",
    answer = "Viburnum"
    ),
    RiddleResponseRemote(
    question = "Blue uniform, white lining, sweet in the middle.",
    answer = "Plum"
    ),
    RiddleResponseRemote(
    question = "Feed — live, drink — die.",
    answer = "Fire"
    ),
    RiddleResponseRemote(
    question = "The more you took, the bigger it became.",
    answer = "Pit"
    ),
    RiddleResponseRemote(
    ...
    RiddleResponseRemote(
    question = "One speaks, two look, two listen.",
    answer = "Tongue, eyes, ears"
    ),
    RiddleResponseRemote(
    ...
    RiddleResponseRemote(
    question = "Squint-eyed, small, in an old gray fur coat.",
    answer = "Hare"
    ),
    RiddleResponseRemote(
    question = "Red-haired, with a fluffy tail, lives in the forest under a bush.",
    answer = "Fox"
    ),
    RiddleResponseRemote(
    question = "Small stature, long tail, gray fur coat, sharp teeth.",
    answer = "Mouse"
    ),
    RiddleResponseRemote(
    question = "He doesn't sleep at night, he guards mice.",
    answer = "Cat"
    ),
    RiddleResponseRemote(
    ...
    RiddleResponseRemote(
    question = "White, not sugar, no legs, but walking.",
    answer = "Snow"
    ),
    RiddleResponseRemote(
    question = "Not a baker, but bakes-blushes.",
    answer = "The Sun"
    ),
    RiddleResponseRemote(
    ...
    RiddleResponseRemote(
    question = "The whole day flies, everyone gets bored, the night comes, then it stops.",
    answer = "Fly"
    ),
    RiddleResponseRemote(
    question = "Blue airplane landed on a white dandelion.",
    answer = "Dragonfly"
    ),
    RiddleResponseRemote(
    ...
    RiddleResponseRemote(
    question = "I'm hunchbacked, but the guys like me.",
    answer = "Camel"
    ),
    RiddleResponseRemote(
    question = "Who was gnawing cones on a branch and throwing leftovers down?",
    answer = "Squirrel"
    ),
    RiddleResponseRemote(
    ...
    RiddleResponseRemote(
    question = "Front — awl, back — fork, top — black cloth, bottom — white towel.",
    answer = "Swallow"
    ),
    RiddleResponseRemote(
    ...
    RiddleResponseRemote(
    question = "The pig is lying, the back is pierced with needles.",
    answer = "Thimble"
    ),
    RiddleResponseRemote(
    question = "Two twins, two brothers, riding on the nose.",
    answer = "Glasses"
    ),
    RiddleResponseRemote(
    ...
    RiddleResponseRemote(
    question = "The whole universe lives in it, but the thing is ordinary.",
    answer = "TV"
    ),
    RiddleResponseRemote(
    question = "It has no legs and no wings, but it flies so that you can't catch up with it.",
    answer = "Time"
    ),
    RiddleResponseRemote(
    question = "Twelve brothers wander after each other, they do not bypass each other.",
    answer = "Months"
    ),
    RiddleResponseRemote(
    question = "Two ends, two rings, in the middle of the carnations.",
    answer = "Scissors"
    ),
    RiddleResponseRemote(
    question = "Flowing-flowing — won't flow out, running-running —won't run out.",
    answer = "River"
    ),
    RiddleResponseRemote(
    question = "Empty we rest, and full we walk.",
    answer = "Boots"
    ),
    RiddleResponseRemote(
    ...
    RiddleResponseRemote(
    question = "Meets everyone with one hand, sees them off with the other.",
    answer = "Door handle"
    ),
    RiddleResponseRemote(
    question = "A pear is hanging — you can't eat.",
    answer = "Light bulb"
    ),
    RiddleResponseRemote(
    question = "The river is flowing — we are lying. Ice on the river — we run.",
    answer = "Skates"
    ),
    RiddleResponseRemote(
    ...
    RiddleResponseRemote(
    question = "Five steps — a ladder, on the steps — a song.",
    answer = "Notes"
    ),
    RiddleResponseRemote(
    question = "In a blue shirt running along the bottom of the ravine.",
    answer = "Trickle"
    ),
    RiddleResponseRemote(
    question = "Fluttering, dancing, waving a patterned fan over a flower.",
    answer = "Butterfly"
    ),
    RiddleResponseRemote(
    question = "Eight legs, like eight hands, embroider a circle with silk",
    answer = "Spider"
    ),
    RiddleResponseRemote(
    ...
    RiddleResponseRemote(
    question = "Transparent as glass, but you can't put it in the window.",
    answer = "Ice"
    ),
    RiddleResponseRemote(
    ...
    RiddleResponseRemote(
    question = "Without hands, without legs, but can draw.",
    answer = "Frost"
    ),
    RiddleResponseRemote(
    ...
    RiddleResponseRemote(
    question = "The pet that starts with",
    answer = " Only one cockroach"
    ),
    RiddleResponseRemote(
    ...
    RiddleResponseRemote(
    question = "Who doesn't get their hair wet in the pouring rain?",
    answer = "Bald"
    ),
    RiddleResponseRemote(
    question = "Can a man marry his widow's sister?",
    answer = "No, since the man is dead"
    ),
    RiddleResponseRemote(
    question = "Usually there are 30 or 31 days in a month. What month has 28 days?",
    answer = "In all"
    ),
    RiddleResponseRemote(
    question = "Who swims faster: duckling or chicken?",
    answer = "Chicken can't swim"
    ),
    RiddleResponseRemote(
    question = "When 2 and 2 are more than four?",
    answer = "When 22"
    ),
    RiddleResponseRemote(
    question = "Housewife's combat weapon. A symbol of warmth and comfort.",
    answer = "Rolling pin"
    ),
    RiddleResponseRemote(
    question = "Why does a person look back?",
    ...
    RiddleResponseRemote(
    question = "Gone old and gray. Came green and young.",
    ...
    RiddleResponseRemote(
    question = "Why does the goat have a sad look?",
    ...
    RiddleResponseRemote(
    question = "What will become wet after drying?",
    answer = "Towel"
    ),
    RiddleResponseRemote(
    ...
    RiddleResponseRemote(
    question = "What happened after March 8th, 2014?",
    answer = "March 9th has come"
    ),
    RiddleResponseRemote(
    ...
    RiddleResponseRemote(
    question = "Which car is decorated with an emblem of four rings?",
    answer = "Audi"
    ),
    RiddleResponseRemote(
    ...
    RiddleResponseRemote(
    question = "Which wheel in the car does not turn when it is driving?",
    answer = "Spare"
    ),
    RiddleResponseRemote(
    ...
    RiddleResponseRemote(
    question = "Why are the duck's legs red?",
    answer = "From the knees"
    ),
    RiddleResponseRemote(
    question = "Forty feet and forty feet is how much?",
    answer = "Eighty- five"
    ),
    RiddleResponseRemote(
    question = "What gets the back of your head with your teeth?",
    answer = "Comb"
    ),
    RiddleResponseRemote(
    question = "Which island says it's clothes?",
    answer = "Jamaica"
    ),
    RiddleResponseRemote(
    question = "What is warmer than one casing?",
    answer = "Two housings"
    ),
    RiddleResponseRemote(
    question = "When a fool is smart.",
    answer = "When silent"
    ),
    RiddleResponseRemote(
    question = "What should I do first when I go to bed?",
    answer = "Sit down"
    ),
    RiddleResponseRemote(
    ...
    RiddleResponseRemote(
    question = "Who shows everyone his face because he doesn't have his own?",
    answer = "Mirror"
    ),
    RiddleResponseRemote(
