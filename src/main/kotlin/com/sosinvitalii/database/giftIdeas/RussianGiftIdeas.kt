...
object RussianGiftIdeas {
    ...
    private val maleGiftIdeas = listOf(
        ...
        "Качественный набор специй или экзотических соусов",
        "Билеты на матч его любимой команды ",
        "Новая спортивная экипировка",
        "Велосипед",
        "Скейтборд",
        "Снаряжение для плавания",
        "Абонемент в спортивный клуб на занятия йогой или фитнесом",
        "Путешествие на выходные или неделю в его любимое место ",
        "Гарнитура для игр",
        "Наушники высокого качества",
        "Кожаный портфель",
        "Качественный ремень из натуральной кожи.",
        "Комплект инструментов для работы с деревом или металлом",
        "Мастер-класс или книга по рукоделию ",
        "Модель самолета, корабля или автомобиля для сборки",
        "Карманный принтер",
        "Настольный биокамин",
        "Настольный левитирующий глобус",
        "Компрессор для автомобиля беспроводной",
        "Умное кольцо Oura Ring",
        "Настольная лампа с беспроводной зарядкой для смартфона",
        "Именной 3D-светильник",
        "Мобильный роутер YOTA",
        "Трекер Apple AirTag",
        "Солевая лампа",
        "Чехол-аккумулятор",
        "Надувной лежак",
        ...
        "Подушка с вашим фото или оригинальным принтом",
        "Полезный онлайн-курс",
        "Подарочный набор мясных деликатесов для мужчин",
        "Фотоаппарат моментальной печати",
        "Плед с вашим фото или оригинальным принтом",
        "Ручной отпариватель",
        "Настольный светильник светодиодное дерево",
        "Светильник с вашим фото или оригинальным принтом",
        "Кружка хамелеон",
        "Термостакан с вашим фото или оригинальным принтом",
        "Умная колонка",
        "Банный халат",
        "Мороженица",
        ...
        "Копилка-сейф",
        "Скретч-карта мира",
        "Картина из нитей по фотографии",
        "Подарочный набор мыла для мужчин",
        "Светильник из гибкого неона",
        "Светящийся коврик для мыши",
        "Подарочный набор бокалов",
        "Подарочный набор «Настоящий мужчина»",
        "Плазменный шар",
        "Умный рюкзак с экраном",
        "Светящаяся карта звездного неба",
        "Светодиодная лента для подсветки комнаты",
        "Набор для создания картины в технике Флюид арт",
        "Триммер XPower",
        "Набор для создания картины «Руки влюбленных»",
        "Пазл",
        "Мольберт",
        "Связка шаров с гелием",
        "Держатель для фотографий",
        "Картины по номерам и контуру",
    ...
    private val femaleGiftIdeas = listOf(
        ...
        "Букет из ее любимых цветов",
        "Серебряное ожерелье с подвеской в форме сердца",
        "Набор высококачественной косметики от известного бренда",
        "Сертификат на спа-процедуры в роскошном спа-салоне",
        "Путешествие на Бали на романтическую неделю",
        "Новый смартфон iPhone последней модели",
        "Комплект художественных кистей и мольберт для ее художественных занятий",
        "Подарочный сертификат в ее любимый онлайн-магазин",
        "Персонализированная серебряная подвеска с ее инициалами",
        "Стильная кожаная сумка ее любимого дизайнера",
        "Абонемент на йога-занятия",
        "Умные наушники с шумоподавлением ",
        "Стильные и удобные домашние тапочки",
        "Халат из мягкого плюша",
        "Часы с элегантным дизайном и кожаным ремешком",
        "Подписка на журнал или газету, которую она любит читать",
        "Комплект для создания своих собственных украшений: бусы, браслеты, серьги и т. д.",
        "Парфюм от ее любимого бренда",
        "Термокружка из нержавеющей стали с ее именем или персонализированным дизайном",
        "Подарочный сертификат на профессиональную фотосессию или семейный портрет",
        "Роскошный набор для ванны с ароматическими маслами, пены для ванн и свечами",
        "Набор высококачественных кистей и косметических средств для макияжа",
        "Подписка на онлайн-курс или мастер-класс по ее увлечению",
        "Электронная книга, чтобы она могла наслаждаться чтением в любое время и в любом месте",
        "Умный браслет для отслеживания активности",
        "Спортивные наушники",
        "Абонемент на концерт ее любимого артиста или группы",
        "Абонемент на концерт мюзикл",
        "Абонемент на театральное представление ",
        "Стильная кофейная машина",
        "Релаксационная подушка с эффектом массажа ",
        "Подарочный набор для создания своих собственных коктейлей с рецептами и необходимыми ингредиентами",
        "Подписка на потоковый сервис",
        "Модная сумка для ноутбука или планшета",
        ...
        "Стильный портфель с ее инициалами ",
        "Комплект для создания своего сада: семена, горшки, садовый инструментарий и уход за растениями",
        "Подарочная подписка на стриминговую платформу",
        "Курс по йоге, медитации",
        "Индивидуальный урок или курс по желаемому виду искусства",
        "Набор для создания ароматической свечи с возможностью выбора ингредиентов",
        "Путешествие на экзотический остров",
        "Велосипед",
        "Скейтборд",
        "Горные лыжи",
        "Подписка на кулинарный журнал или онлайн-платформу с рецептами и кулинарными идеями",
        "Чайный набор с разнообразными видами чая, кружками и чайными аксессуарами",
        "Персонализированная фотокнига с воспоминаниями и фотографиями",
        "Аксессуары для йоги, такие как коврик, блоки, ремни",
        "Комплект для создания своего собственного сада на подоконнике или балконе",
        "Экскурсия или мастер-класс по ее интересам или хобби",
        "Комплект для домашнего спа-дня с ароматическими маслами, масками для лица, скрабами и свечами.",
        "Кулон с ее именем или инициалами.",
        "Браслет с ее именем или инициалами",
        "Набор экзотических специй и приправ",
        "Голосовой помощник",
        "Умная светотехника",
        "Подарочная подписка на массажный салон",
        "Сеансы физиотерапии ",
        "Качественный столовый сервиз",
        "Набор для создания собственных натуральных косметических средств",
        "Стильные и удобные наушники или беспроводные Bluetooth-наушники.",
        "Курс или занятия по танцам",
        "Подписка на музыкальный сервиз",
        "Стильный и функциональный смарт-браслет",
        "Электронная детская игровая консоль",
        "Планшет",
        "Кулинарный тур",
        "Гастрономическая экскурсия",
        "Интерактивная фитнес-платформа",
        "Комплект для создания своих собственных смузи ",
        "Эксклюзивная винная коллекция",
        "Персонализированный дневник или блокнот с ее именем или мотивационным посланием",
        "Устройство для аэрографии ногтей",
        "Набор для создания профессионального маникюра и педикюра",
        "Стильная и удобная солнцезащитная одежда",
        "Аксессуары для летних путешествий",
        "Набор для создания своего собственного мыла",
        "Подписка на сервис доставки еды",
        "Готовые наборы рецептов",
        "Эксклюзивные кожаные перчатки",
        "Аксессуары для зимней моды",
        "Курс или занятия по фотографии",
        "Устройство для стриминга фильмов и телешоу",
        "Набор инструментов и материалов для рукоделия",
        "Лампа-колонка для пробуждения светом и музыкой",
        "Карманный принтер",
        "Массажеры для лица и тела Rowenta",
        "Браслеты из обсидианового камня Iziq",
        "Фен-щетка Rowenta",
        "Настольный светильник светодиодное дерево",
        "Умное кольцо Oura Ring",
        "Именной 3D-светильник",
        "Расчёска TANGLE TEEZER",
        "Плед с рукавами",
        "Светильник с вашим фото или оригинальным принтом",
        "Роза в колбе",
        "Беспроводная зарядка для телефона",
        "Плед с вашим фото или оригинальным принтом",
        "Бокалы с оригинальной надписью",
        "Настольное зеркало с подсветкой",
        "Термостакан с вашим фото или оригинальным принтом",
        "Кулон I love You на 100 языках",
        "Кастинг в школе моделей",
        "Букет из клубники в шоколаде",
        "Робот-пылесос",
        "Настольный фонтан с подсветкой",
        "Электронная фоторамка",
        "Подарочный кофейный набор",
        "Электрическая расческа-выпрямитель",
        "Настольная лампа с беспроводной зарядкой для смартфона",
        "Большой набор для маникюра",
        ...
        "Надувной лежак",
        "Бьюти-кейс",
        "Маска для сна со встроенными наушниками",
        "Мишка из роз 3D",
        "Держатель для фотографий",
        "Кулон со знаком зодиака",
        "Объектив для смартфона",
        "Дозатор жидкого мыла",
        "Кружка хамелеон",
        "Настольный органайзер",
        "Планшет для рисования Xiaomi",
        "Плойка",
        "Светильник из гибкого неона",
        "Кресло-мешок",
        "Набор для приготовления суши и роллов",
        "Фотосессия",
        "Набор для рисования эпоксидной смолой",
        "Швейная машинка",
        "Гирлянда штора",
