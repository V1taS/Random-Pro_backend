...
import com.sosinvitalii.database.goodDeeds.GoodDeeds
import com.sosinvitalii.database.goodDeeds.Language
import io.ktor.http.*
import io.ktor.server.application.*
import io.ktor.server.response.*

class GoodDeedsController(private val call: ApplicationCall) {
    suspend fun perform() {
        ...
        val names = GoodDeeds.fetch(languageEnum)
        call.respond(names)
    }
}
