...
import com.sosinvitalii.database.jokes.Jokes
import com.sosinvitalii.database.jokes.Language
import io.ktor.http.*
import io.ktor.server.application.*
import io.ktor.server.response.*

class JokesController(private val call: ApplicationCall) {
    suspend fun perform() {
        ...
        val names = Jokes.fetch(languageEnum)
        call.respond(names)
    }
}