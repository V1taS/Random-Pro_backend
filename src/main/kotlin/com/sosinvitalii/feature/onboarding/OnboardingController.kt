...
import com.sosinvitalii.database.onboarding.Language
import com.sosinvitalii.database.onboarding.Onboarding
import io.ktor.http.*
import io.ktor.server.application.*
import io.ktor.server.response.*

class OnboardingController(private val call: ApplicationCall) {
    suspend fun perform() {
        ...
        val onboarding = Onboarding.fetch(languageEnum)
        call.respond(onboarding)
    }
}