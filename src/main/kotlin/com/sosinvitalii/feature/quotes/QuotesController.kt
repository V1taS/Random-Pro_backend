...
import com.sosinvitalii.database.quotes.Language
import com.sosinvitalii.database.quotes.Quotes
import io.ktor.http.*
import io.ktor.server.application.*
import io.ktor.server.response.*

class QuotesController(private val call: ApplicationCall) {
    suspend fun perform() {
        ...
        val names = Quotes.fetch(languageEnum)
        call.respond(names)
    }
}